...
'use strict';
var zones=[
 {title:'The Rice Archive',kicker:'Living archive',copy:'200+ varieties. One living archive.',image:'https://ik.imagekit.io/18ab23oqaj/zone3.png'},
 {title:'Hands of Rice',kicker:'Sculptural hands',copy:'From seed to serving hands.',image:'https://ik.imagekit.io/18ab23oqaj/zone6.png'},
 {title:'How the World Eats Rice',kicker:'Forty metre table',copy:'Forty metres of tables.',image:'https://ik.imagekit.io/18ab23oqaj/zone5.png'},
 {title:'Beyond the Bowl',kicker:'Window installation',copy:'A window you cannot pass.',image:'https://ik.imagekit.io/18ab23oqaj/zone9.png'},
 {title:'The World Within',kicker:'Macro grain projection',copy:'A grain becomes a universe.',image:'https://ik.imagekit.io/18ab23oqaj/zone7.png'},
 {title:'Rice Mirror',kicker:'Mirror installation',copy:'The grains know your face.',image:'https://ik.imagekit.io/18ab23oqaj/zone8.png'},
 {title:'The Rice Route Map',kicker:'Illuminated export route map',copy:'From Indian fields to the world’s plates.',image:'https://ik.imagekit.io/18ab23oqaj/zone1.png'},
 {title:'Rice Through Time',kicker:'Timeline corridor',copy:'Ancient grain, future harvest.',image:'https://ik.imagekit.io/18ab23oqaj/zone4.png'},
 {title:'Seed Cloud',kicker:'Suspended capsules',copy:'A cloud of capsules. A network of intelligence.',image:'https://ik.imagekit.io/18ab23oqaj/zone2.png'}
];
var byTitle={};zones.forEach(function(z){byTitle[z.title]=z});
