...
- The homepage Passes section must show VIP, Standard and Rice Festival together in one three-column mobile frame. The Published Across label, moving outlet rail and See Coverage control must share one single horizontal line, including when Mobile view is forced on a wide desktop browser.
