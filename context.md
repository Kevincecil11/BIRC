...
Desktop homepage eyebrow titles use 13.2px Poppins, a 20% increase from the previous 11px shared size. The Purpose statement keeps the increased 46-65px scale and is deliberately composed as three lines on wide desktop so it stays inside the frame.
